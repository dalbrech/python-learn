...
start.setStyleSheet('QPushButton {background-color: #80FF80; font-size: 18px; height: 40px}')
stop.setStyleSheet('QPushButton {background-color: #FF8080; font-size: 18px; height: 40px}')
